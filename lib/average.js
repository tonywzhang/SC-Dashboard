...
export const updateAverage = () => {
  const interval = setInterval(function() {
    ...
    document.getElementById('average').innerHTML = `<a class="netWorth" href='http://www.espn.com/nba/player/_/id/3975/stephen-curry'>${parseFloat(runningAverage).toFixed(1)}<a/>`;
    document.getElementById('gameCount').innerHTML = `<a class="netWorth" href='http://www.espn.com/nba/player/_/id/3975/stephen-curry'>${formatNum(game)}<a/>`;formatNum(game);
    document.getElementById('opponent').innerHTML = `<a class="netWorth" href='http://www.espn.com/nba/player/_/id/3975/stephen-curry'>${gameData[game-1].opp}<a/>`;
    if (game === 51){
